...
class MibInstrumController(AbstractMibInstrumController):
    ...
    def _flipFlopFsmCb(self, varBind, idx, **context):
        ...
        debug.logger & debug.flagIns and debug.logger(
            '_flipFlopFsmCb: finished, input %r output %r' % (varBind, varBinds))
    ...
    def flipFlopFsm(self, fsmTable, *varBinds, **context):
        ...
        for idx, varBind in enumerate(varBinds):
            try:
                ...
                #mgmtFun(varBind, self._flipFlopFsmCb, idx=idx, **context)
